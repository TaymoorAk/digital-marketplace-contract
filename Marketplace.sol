...
contract NFT is ERC721URIStorage{
    ...
    constructor(address marketplaceAddress) ERC721("Taymoor Marketplace","TAK"){
...
contract CroPunksMarket is ReentrancyGuard{
    using Counters for Counters.Counter;
    ...
    function createMarketSale(address nftContract, uint256 itemId) public payable nonReentrant{
        ...
        require(msg.value == price,"Please submit the asking price in order to complete transaction");
